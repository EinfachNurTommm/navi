...
public class SkullCreator {
    ...
    public static ItemStack buildHeadName(String owner, String name) {
        ItemStack is = itemFromName(owner);
    ...
    public static ItemStack buildHeadBase(String base64, String name) {
        ItemStack is = itemFromBase64(base64);
        SkullMeta im = (SkullMeta)is.getItemMeta();
        im.setDisplayName(name);
        is.setItemMeta(im);
        return is;
    ...
    public static ItemStack buildHeadUUID(UUID id, String name) {
        ItemStack is = itemFromUuid(id);
        SkullMeta im = (SkullMeta)is.getItemMeta();
        im.setDisplayName(name);
        is.setItemMeta(im);
        return is;
    ...
    public static ItemStack buildHeadURL(String url, String name) {
        ItemStack is = itemFromUrl(url);
        SkullMeta im = (SkullMeta)is.getItemMeta();
        im.setDisplayName(name);
        is.setItemMeta(im);
        return is;
